...
class Activity extends jni$_.JObject {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  view$_.View? onCreatePanelView(int i) {
  ...
  bool onPreparePanel(int i, view$_.View? view, jni$_.JObject? menu) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    final _$menu = menu?.reference ?? jni$_.jNullReference;
  ...
  void setContentView(view$_.View? view) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    _setContentView(
      reference.pointer,
