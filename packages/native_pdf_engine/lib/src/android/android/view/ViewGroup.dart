...
class ViewGroup$LayoutParams extends jni$_.JObject {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  factory ViewGroup$LayoutParams.new$2(int i, int i1) {
    return ViewGroup$LayoutParams.fromReference(
      _new$2(
        _class.reference.pointer,
  ...
  void resolveLayoutDirection(int i) {
...
final class $ViewGroup$LayoutParams$NullableType$
  ...
  @core$_.override
  ViewGroup$LayoutParams? fromReference(jni$_.JReference reference) =>
      reference.isNull ? null : ViewGroup$LayoutParams.fromReference(reference);
  @jni$_.internal
  @core$_.override
...
final class $ViewGroup$LayoutParams$Type$
  ...
  @core$_.override
  ViewGroup$LayoutParams fromReference(jni$_.JReference reference) =>
      ViewGroup$LayoutParams.fromReference(reference);
  @jni$_.internal
  @core$_.override
  jni$_.JType get superType => const jni$_.$JObject$NullableType$();
...
class ViewGroup$MarginLayoutParams extends ViewGroup$LayoutParams {
  ...
  static final _id_bottomMargin = _class.instanceFieldId(r'bottomMargin', r'I');
  ...
  static final _id_leftMargin = _class.instanceFieldId(r'leftMargin', r'I');
  ...
  static final _id_rightMargin = _class.instanceFieldId(r'rightMargin', r'I');
  ...
  static final _id_topMargin = _class.instanceFieldId(r'topMargin', r'I');
  ...
  /// from: `public void <init>(int i, int i1)`
  /// The returned object must be released after use, by calling the [release] method.
  factory ViewGroup$MarginLayoutParams.new2(int i, int i1) {
    return ViewGroup$MarginLayoutParams.fromReference(
      _new2(
        _class.reference.pointer,
  ...
  void setMargins(int i, int i1, int i2, int i3) {
    _setMargins(
      reference.pointer,
...
final class $ViewGroup$MarginLayoutParams$NullableType$
  ...
  ViewGroup$MarginLayoutParams? fromReference(jni$_.JReference reference) =>
      reference.isNull
      ? null
      : ViewGroup$MarginLayoutParams.fromReference(reference);
  @jni$_.internal
  @core$_.override
...
class ViewGroup$OnHierarchyChangeListener extends jni$_.JObject {
  ...
  @jni$_.internal
  ViewGroup$OnHierarchyChangeListener.fromReference(jni$_.JReference reference)
    : $type = type,
      super.fromReference(reference);
    ...
    try {
      ...
      if ($d == r'onChildViewAdded(Landroid/view/View;Landroid/view/View;)V') {
        _$impls[$p]!.onChildViewAdded(
          $a![0]?.as(const view$_.$View$Type$(), releaseOriginal: true),
          $a![1]?.as(const view$_.$View$Type$(), releaseOriginal: true),
        );
...
final class $ViewGroup$OnHierarchyChangeListener$NullableType$
  ...
  ViewGroup$OnHierarchyChangeListener? fromReference(
    jni$_.JReference reference,
      ...
      ? null
      : ViewGroup$OnHierarchyChangeListener.fromReference(reference);
  @jni$_.internal
  @core$_.override
  jni$_.JType get superType => const jni$_.$JObject$NullableType$();
...
class ViewGroup extends view$_.View {
  @jni$_.internal
  @core$_.override
  ...
  void addFocusables1(jni$_.JObject? arrayList, int i, int i1) {
    final _$arrayList = arrayList?.reference ?? jni$_.jNullReference;
    _addFocusables1(
      reference.pointer,
      _id_addFocusables1 as jni$_.JMethodIDPtr,
      _$arrayList.pointer,
      i,
      i1,
    ).check();
  ...
  void addView$2(view$_.View? view, int i) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    _addView$2(
      reference.pointer,
  ...
  void addView$4(view$_.View? view, int i, int i1) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    _addView$4(
      reference.pointer,
  ...
  void childHasTransientStateChanged(view$_.View? view, bool z) {
    final _$view = view?.reference ?? jni$_.jNullReference;
  ...
  void dispatchSetActivated(bool z) {
  ...
  void dispatchSetSelected(bool z) {
  ...
  bool dispatchUnhandledMove(view$_.View? view, int i) {
    final _$view = view?.reference ?? jni$_.jNullReference;
  ...
  static final _id_focusSearch$1 = _class.instanceMethodId(
    r'focusSearch',
  ...
  /// The returned object must be released after use, by calling the [release] method.
  view$_.View? focusSearch$1(view$_.View? view, int i) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    return _focusSearch$1(
      reference.pointer,
      _id_focusSearch$1 as jni$_.JMethodIDPtr,
      _$view.pointer,
      i,
    ).object<view$_.View?>(const view$_.$View$NullableType$());
  }
  ...
  int getChildDrawingOrder(int i) {
  ...
  static int getChildMeasureSpec(int i, int i1, int i2) {
  ...
  static final _id_getOverlay$1 = _class.instanceMethodId(
    r'getOverlay',
    r'()Landroid/view/ViewGroupOverlay;',
  );

  static final _getOverlay$1 =
      jni$_.ProtectedJniExtensions.lookup<
            jni$_.NativeFunction<
              jni$_.JniResult Function(
                jni$_.Pointer<jni$_.Void>,
  ...
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JObject? getOverlay$1() {
    return _getOverlay$1(
      reference.pointer,
      _id_getOverlay$1 as jni$_.JMethodIDPtr,
    ).object<jni$_.JObject?>(const jni$_.$JObject$NullableType$());
  }
  ...
  int indexOfChild(view$_.View? view) {
    final _$view = view?.reference ?? jni$_.jNullReference;
  ...
  bool onInterceptHoverEvent(jni$_.JObject? motionEvent) {
    final _$motionEvent = motionEvent?.reference ?? jni$_.jNullReference;
  ...
  bool onInterceptTouchEvent(jni$_.JObject? motionEvent) {
    final _$motionEvent = motionEvent?.reference ?? jni$_.jNullReference;
  ...
  bool onNestedFling(view$_.View? view, double f, double f1, bool z) {
    final _$view = view?.reference ?? jni$_.jNullReference;
  ...
  bool onNestedPreFling(view$_.View? view, double f, double f1) {
    final _$view = view?.reference ?? jni$_.jNullReference;
  ...
  void onNestedScroll(view$_.View? view, int i, int i1, int i2, int i3) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    _onNestedScroll(
      reference.pointer,
  ...
  void onNestedScrollAccepted(view$_.View? view, view$_.View? view1, int i) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    final _$view1 = view1?.reference ?? jni$_.jNullReference;
  ...
  bool onStartNestedScroll(view$_.View? view, view$_.View? view1, int i) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    final _$view1 = view1?.reference ?? jni$_.jNullReference;
  ...
  void propagateRequestedFrameRate(double f, bool z) {
  ...
  void removeViewsInLayout(int i, int i1) {
  ...
  void requestDisallowInterceptTouchEvent(bool z) {
  ...
  bool requestFocus2(int i, jni$_.JObject? rect) {
    final _$rect = rect?.reference ?? jni$_.jNullReference;
    return _requestFocus2(
      reference.pointer,
      _id_requestFocus2 as jni$_.JMethodIDPtr,
      i,
      _$rect.pointer,
    ).boolean;
  }
  ...
  void setAddStatesFromChildren(bool z) {
  ...
  void setAlwaysDrawnWithCacheEnabled(bool z) {
  ...
  void setAnimationCacheEnabled(bool z) {
  ...
  void setLayoutAnimation(jni$_.JObject? layoutAnimationController) {
  ...
  void setLayoutAnimationListener(jni$_.JObject? animationListener) {
  ...
  void setLayoutTransition(jni$_.JObject? layoutTransition) {
  ...
  void setMotionEventSplittingEnabled(bool z) {
  ...
  void setTouchscreenBlocksFocus(bool z) {
  ...
  void setTransitionGroup(bool z) {
    _setTransitionGroup(
      reference.pointer,
  ...
  bool showContextMenuForChild(view$_.View? view) {
    final _$view = view?.reference ?? jni$_.jNullReference;
  ...
  bool showContextMenuForChild$1(view$_.View? view, double f, double f1) {
    final _$view = view?.reference ?? jni$_.jNullReference;
...
final class $ViewGroup$NullableType$ extends jni$_.JType<ViewGroup?> {
  ...
  @core$_.override
  ViewGroup? fromReference(jni$_.JReference reference) =>
      reference.isNull ? null : ViewGroup.fromReference(reference);
  @jni$_.internal
  @core$_.override
  jni$_.JType get superType => const view$_.$View$NullableType$();
...
final class $ViewGroup$Type$ extends jni$_.JType<ViewGroup> {
  ...
  @core$_.override
  ViewGroup fromReference(jni$_.JReference reference) =>
      ViewGroup.fromReference(reference);
  @jni$_.internal
  @core$_.override
  jni$_.JType get superType => const view$_.$View$NullableType$();
