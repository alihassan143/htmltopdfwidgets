...
// https://github.com/flutter/packages/blob/main/packages/google_fonts/lib/src/google_fonts_parts/part_n.g.dart
//
...
abstract class GoogleFontsFile {
  String get faceName;
  Uri get uri;
}

class GoogleFontsFileCJK implements GoogleFontsFile {
  const GoogleFontsFileCJK(this.faceName, this.uri);
  @override
...
GoogleFontsFile? getGoogleFontsUriFromFontQuery(PdfFontQuery query, {bool preferCJK = true}) {
  ...
  if (!kIsWeb &&
    ...
    if (query.isRoman) return notoSerifCJK;
    return notoSansCJK;
  }
...
final _notoSans = <int, GoogleFontsFileSingle>{
...
/// See:
///  * https://fonts.google.com/specimen/Noto+Sans
final _notoSansItalic = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSans-Italic',
    100,
...
final _notoSansSc = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSansSC',
    100,
...
final _notoSansTc = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSansTC',
    100,
...
final _notoSansJp = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSansJP',
    100,
...
final _notoSansKr = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSansKR',
    100,
...
final _notoSansThai = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSansThai',
    100,
...
final _notoSansHebrew = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSansHebrew',
    100,
...
final _notoSansArabic = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSansArabic',
    100,
...
final _notoSerif = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSerif',
    100,
...
/// See:
///  * https://fonts.google.com/specimen/Noto+Serif
final _notoSerifItalic = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSerif-Italic',
    100,
...
final _notoSerifSc = <int, GoogleFontsFileSingle>{
  200: GoogleFontsFileSingle(
    'NotoSerifSC',
    200,
...
final _notoSerifTc = <int, GoogleFontsFileSingle>{
  200: GoogleFontsFileSingle(
    'NotoSerifTC',
    200,
...
final _notoSerifJp = <int, GoogleFontsFileSingle>{
  200: GoogleFontsFileSingle(
    'NotoSerifJP',
    200,
...
final _notoSerifKr = <int, GoogleFontsFileSingle>{
  200: GoogleFontsFileSingle(
    'NotoSerifKR',
    200,
...
final _notoSerifThai = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSerifThai',
    100,
...
final _notoSerifHebrew = <int, GoogleFontsFileSingle>{
  100: GoogleFontsFileSingle(
    'NotoSerifHebrew',
    100,
...
final _notoNaskhArabic = <int, GoogleFontsFileSingle>{
  400: GoogleFontsFileSingle(
    'NotoNaskhArabic',
    400,
