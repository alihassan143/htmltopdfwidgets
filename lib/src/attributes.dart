...
class BuiltInAttributeKey {
  ...
  static String strikethrough = 'strikethrough'; // Text should have a strikethrough line.
  static String color = 'color'; // Text color customization.
  static String backgroundColor = 'backgroundColor'; // Background color customization.
  static String font = 'font'; // Font customization.
  static String href = 'href'; // Hyperlink attribute for text.

  // Global rendering types
  static String subtype = 'subtype'; // Subtype for customizing rendering behavior.
  static String heading = 'heading'; // Text should be treated as a heading (h1, h2, h3, etc.).
  ...
  static String bulletedList = 'bulleted-list'; // Text should be displayed in a bulleted list.
  static String numberList = 'number-list'; // Text should be displayed in a numbered list.

  static String quote = 'quote'; // Text should be displayed as a blockquote.
  static String checkbox = 'checkbox'; // Text should be displayed as a checkbox.
  static String code = 'code'; // Text should be displayed as code.
  static String number = 'number'; // Text should be displayed as a numbered item.
